...
class WP_Bootstrap_Theme {
	...
	public function enqueue_assets() {
		wp_enqueue_style(
			...
			array(),
			( defined( 'WP_DEBUG' ) ? null : filemtime( get_template_directory() . '/dist/css/theme.min.css' ) )
		);
		...
		wp_enqueue_script(
			...
			array(),
			( defined( 'WP_DEBUG' ) ? null : filemtime( get_template_directory() . '/dist/css/theme.min.js' ) ),
			true
		);
	}
	...
	public static function setup_theme() {
		...
		register_nav_menus(
			array(
				'primary' => __( 'Primary Navigation', '_bootstrap' ),
			)
		);
	}
